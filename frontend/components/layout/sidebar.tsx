...
export function Sidebar({ pages, className }: SidebarProps) {
  return (
    <aside
      className={cn(
        "flex h-full flex-col border-r border-gray-200 dark:border-dark-border bg-gray-50 dark:bg-dark-bg transition-colors",
        className
      )}
    >
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-gray-200 dark:border-dark-border px-4">
      ...
      <footer className="mt-auto border-t border-gray-200 dark:border-dark-border px-4 py-3">
        <button
          onClick={async () => {
